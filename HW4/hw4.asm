...
Init:	lds	#$01FF	* initiate stack pointer
	...
	oraa	#$80
	staa	OPTION
	ldaa	#$2E	* set some ascii constants
	staa	Dot
	ldaa	#$00
	staa	Finish
	ldaa	#$0A
...
Mode1:
	...
	staa	Unit
Mode11:
	jsr	Read_AD	* get value from A/D
	jsr	Fill_Digits	* do the math and save digits
	ldx	#Dig5	* load address to first digit into x
	jsr	Output	* output that sequence
	jsr	Check_Input	* check for mode change
